...
import com.sbhave.appPurchase.Consts.ResponseCode;
import com.sbhave.appPurchase.Security.VerifiedPurchase;
...
public class BillingService extends Service implements ServiceConnection {
    ...
    class RequestPurchase extends BillingRequest {
        ...
        protected long run() throws RemoteException {
            ...
            Log.e("SAUMITRA", "Starting purchase");
            ...
            Method mStartIntentSender = null;
            try {
    ...
    public static String getPendingRequests(){
    	StringBuilder ret = new StringBuilder("<transactions>");
